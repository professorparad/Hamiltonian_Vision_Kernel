...
across MPS bond dimension (N=6 fixed), replayed on the IonQ ideal cloud
simulator. Companion to
plot_checkpoint_bond_dimension_temperature_hardware_summary.py's IBM figure,
using the IonQ JSON already archived by
run_checkpoint_bond_dimension_temperature_hardware_sweep.py."""
...
# as a division-by-near-zero artifact, not a physical signal (matches the IBM figure).
BOND_DIMS = [2, 4, 8]

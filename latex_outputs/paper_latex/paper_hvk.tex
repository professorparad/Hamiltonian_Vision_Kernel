...
\begin{itemize}
    ...
    \item \textbf{An entanglement-necessity result}: within a restricted, leakage-audited feature class and fixed linear-readout protocol, entangling pair observables are necessary when the target explicitly depends on distant-patch products (Section~\ref{sec:entanglement_necessity}).

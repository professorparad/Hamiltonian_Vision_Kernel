...
that HVK2D is statistically \emph{competitive} with \snew{a resource-matched
raw/local linear classical control}, and it substantially
...
physically motivated regularisers, or tensor-network structure that classical
...
\emph{learnable Hamiltonian energy diagnostic} (full nearest-neighbour
...
regulariser that a kernel construction has no analogue for.
...
Section~\ref{sec:ablation_relationship} summarises its central finding and how it

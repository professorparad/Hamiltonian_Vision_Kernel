...
per-image optimisation and reconstruction capability, not held-out
...
Reproducibility}. On held-out CIFAR-10, \snew{the raw/local linear control} reaches
$18.80\pm1.42$~dB against HVK2D's $18.12\pm1.54$~dB; after aggregating
...
rather than merely ``not shown to differ'': \snew{five of seven distinct} tested controls
are statistically equivalent to HVK2D within that margin, while the two weakest

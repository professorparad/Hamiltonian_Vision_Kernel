...
that HVK2D is statistically \emph{competitive} with a resource-matched
...
\begin{enumerate}\itemsep3pt
  ...
  \item \textbf{Competitive with resource-matched classical baselines.} A
        ...
        statistically equivalent, within a $\pm1$~dB margin, to five of seven
...
Reproducibility}. On held-out CIFAR-10, the raw/local linear control reaches
...
rather than merely ``not shown to differ'': five of seven distinct tested controls

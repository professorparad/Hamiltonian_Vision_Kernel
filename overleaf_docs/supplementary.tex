...
\usepackage{float}
% ---- REVIEW MARKUP ONLY. Remove xcolor and every \color{red} reviewer
% ---- block below before arXiv or journal submission. See
% ---- overleaf_docs/manuscript_editing_memory.md, Section 4.
\usepackage{xcolor}
